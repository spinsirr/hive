...
export function AgentResponse({
  ...
  return (
    <MessageResponse
      className="hive-response min-w-0 space-y-3 text-sm leading-6 [overflow-wrap:anywhere] [&_h1]:text-base [&_h2]:text-sm [&_h3]:text-sm [&_li]:my-0.5 [&_ol]:my-2 [&_p]:leading-6 [&_pre]:text-xs [&_ul]:my-2"
      controls={controls}
