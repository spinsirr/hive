...
} from "@/lib/workspace/workspace-file-type";
...
export function WorkspaceFileIcon({
  ...
  return (
    <span
      aria-hidden="true"
      className={`inline-flex size-4 shrink-0 items-center justify-center rounded-[2px] ${appearance.color}`}
    >
      {appearance.badge ? (
