...
import { withHiveCodexTools } from "../tools/hive-codex-tools.ts";
    ...
    async getBootstrap(...args: Parameters<NonNullable<typeof getBootstrap>>) {
      ...
      const assets = [
        ...["app-server-connection.mjs", "turn-collector.mjs"].map((name) => [
          name,
          path.join(process.cwd(), "src/server/agents/codex/bridge", name),
        ]),
        [
          "runtime.mjs",
        ...
        [
          "bridge.mjs",
          path.join(process.cwd(), "src/server/agents/codex/bridge/bridge.mjs"),
        ],
        [
          "app-server.mjs",
          path.join(
            process.cwd(),
            "src/server/agents/codex/bridge/app-server.mjs"
          ),
        ],
        [
          "auth.mjs",
          path.join(process.cwd(), "src/server/agents/codex/bridge/auth.mjs"),
        ],
        [
          "subagents.mjs",
          path.join(
            process.cwd(),
            "src/server/agents/codex/bridge/subagents.mjs"
          ),
        ],
        [
          ...
          path.join(
            process.cwd(),
            "src/server/agents/codex/bridge/gateway-transport.mjs"
          ),
        ],
        [
