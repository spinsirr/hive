import { z } from "zod";
import { codeReferenceSchema } from "./code-reference.ts";
import { codingEfforts } from "./coding-effort.ts";
import { isClientSubmissionId, MESSAGE_BODY_LIMIT } from "./message-draft.ts";
