...
function inspect(file, source) {
  ...
  const local = demo || file === "src/lib/demo/demo-workspace.ts";
...
assert.ok(
  inspect("src/lib/demo/demo-workspace.ts", "fetch('/api/sessions')").length
);
assert.ok(
  inspect("src/lib/demo/demo-workspace.ts", "new WebSocket(url)").length
);
assert.ok(
...
assert.ok(
  inspect(
    "src/lib/demo/demo-workspace.ts",
