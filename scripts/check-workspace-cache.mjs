...
const { default: CodeViewer } =
  await import("../src/components/hive/code-viewer.tsx");
...
const { WorkspaceFiles } =
  await import("../src/components/hive/workspace-files.tsx");
const { WorkspaceReadCache } =
  await import("../src/components/hive/workspace-read-cache.tsx");
