...
This follow-up supersedes the integration and second-account-login blockers in the earlier snapshot below. Fresh-user production signup/foreign-task denial, a new live subagent/Stop/result acceptance, the timed narrated rehearsal and owner-controlled publication/submission gates remain separate.
